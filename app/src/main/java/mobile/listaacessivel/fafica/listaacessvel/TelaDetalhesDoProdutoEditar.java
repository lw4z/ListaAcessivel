        ...
        builder.setPositiveButton("Sim", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface arg0, int arg1) {
                ...
                if(!quantidadeProduto.getText().toString().equals("")){
                    ...
                    Toast.makeText(TelaDetalhesDoProdutoEditar.this,"Informe a quantidade do produto!", Toast.LENGTH_LONG).show();
                    return;
                }
                ...
                if(quantidade >= 1){
                    ...
                    Toast.makeText(TelaDetalhesDoProdutoEditar.this,"A quantidade do produto precisa ser mais que 0", Toast.LENGTH_LONG).show();
                    return;
                }
            }
        });
