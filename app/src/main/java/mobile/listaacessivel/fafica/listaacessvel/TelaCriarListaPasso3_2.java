...
public class TelaCriarListaPasso3_2 extends ActionBarActivity {
    ...
    public void getMessage(String mensagem) {
        ...
        builder.setPositiveButton("Sim", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface arg0, int arg1) {
                Intent it = new Intent(TelaCriarListaPasso3_2.this,TelaFinalizarLista.class);
...
//    private void loadList(int number)
//    {
//        ArrayList<Produto> sort = new ArrayList<Produto>();
...
//            }
//        }
//        adapter = new MyArrayAdapterCriarListaPasso3(getApplicationContext(),sort);
//        listaProdutos.setAdapter(adapter);
//    }
}
